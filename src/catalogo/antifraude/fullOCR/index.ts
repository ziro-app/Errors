...
export type FullOCRPromptMessage<N extends keyof FullOCRPromptCollection,D = GetFullOCRPromptData<N>> = PromptMessage<FullOCRPromptCollection,N,D>
...
export type GetFullOCRWaitingCode<N extends keyof FullOCRWaitingCollection> = GetWaitingCode<FullOCRWaitingCollection,N>
export type GetFullOCRWaitingData<N extends keyof FullOCRWaitingCollection> = GetWaitingData<FullOCRWaitingCollection,N>
export type FullOCRWaitingMessage<N extends keyof FullOCRWaitingCollection,D = GetFullOCRWaitingData<N>> = WaitingMessage<FullOCRWaitingCollection,N,D>