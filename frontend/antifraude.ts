...
MISSING_EXP_DATE: ZiroMessageData = {
    ...
    user: {
        description: "A data de expedição do documento enviada não pode ser extraída para a análise.",
...
EXPIRED_DOC: ZiroMessageData = {
    ...
    illustration: "paymentError",
    user: {
        description: "O documento possui data de expedição maior do que a permitida pela Ziro.",
...
NO_FACE_OBJECT: ZiroMessageData = {
    ...
    illustration: "paymentError",
    user: {
        description: "Esse tipo de documento deve possuir a foto do rosto do portador, mas nenhuma foi encontrada.",
...
CANNOT_ANALYZE_FACE: ZiroMessageData = {
    ...
    illustration: "paymentError",
    user: {
        description: "Houve um erro ao tentar analisar o rosto contido no documento, provavelmente por causa da qualidade da imagem.",
